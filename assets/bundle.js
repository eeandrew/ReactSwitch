...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactSwitch = __webpack_require__(160);
	...
	var TestRunningNumber = function (_React$Component) {
		_inherits(TestRunningNumber, _React$Component);

		function TestRunningNumber() {
			_classCallCheck(this, TestRunningNumber);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TestRunningNumber).call(this));
		...
		_createClass(TestRunningNumber, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						' ',
						_react2.default.createElement('input', { value: this.state.value, onChange: this.handleValueChange.bind(this) })
					),
					_react2.default.createElement(
						'div',
						{ style: ctrlStyle },
						...
						_react2.default.createElement('input', { value: this.state.format, onChange: this.handleFormatChange.bind(this) })
					),
					_react2.default.createElement(
						'div',
						{ style: ctrlStyle },
						_react2.default.createElement(RunningNumber, { rnStyle: 'my-running-number odometer odometer-theme-default', value: this.state.value, format: this.state.format })
					)
				);
			}
		}]);

		return TestRunningNumber;
	}(_react2.default.Component);

	_reactDom2.default.render(_react2.default.createElement(_ReactSwitch2.default, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactSwitch = function (_React$Component) {
		_inherits(ReactSwitch, _React$Component);

		function ReactSwitch() {
			_classCallCheck(this, ReactSwitch);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ReactSwitch).call(this));
